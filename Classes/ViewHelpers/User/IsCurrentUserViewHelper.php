...
class IsCurrentUserViewHelper extends AbstractConditionViewHelper
{
    ...
    public static function verdict(array $arguments, RenderingContextInterface $renderingContext): bool
    {
        ...
        if (static::$currentUser === null) {
            static::$currentUser = GeneralUtility::makeInstance(AuthenticationService::class)->getUser();
        }

        return $user !== null && ($user->getUid() === static::$currentUser->getUid());
    }
}
